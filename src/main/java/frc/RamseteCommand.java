 ...
 *
 * <p>
 * The command handles trajectory-following, PID calculations, and feedforwards internally. This is intended to be a
 * more-or-less "complete solution" that can be used by teams without a great deal of controls expertise.
 *
 * <p>
 * Advanced teams seeking more flexibility (for example, those who wish to use the onboard PID functionality of a
 * "smart" motor controller) may use the secondary constructor that omits the PID and feedforward functionality,
...
public class RamseteCommand extends CommandBase {
	 ...
	 *
	 * <p>
	 * Note: The controller will *not* set the outputVolts to zero upon completion of the path - this is left to the
	 ...
	 * @param wheelSpeeds
	 *            A function that supplies the speeds of the left and right sides of the robot drive.
	 ...
	 * @param outputVolts
	 *            A function that consumes the computed left and right outputs (in volts) for the robot drive.
	 * @param requirements
