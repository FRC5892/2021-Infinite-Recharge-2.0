...
public class DriveTrain extends SubsystemBase {
	...
	public DriveTrain() {
		...
		drivetrainSimulator = new DifferentialDrivetrainSim(
				LinearSystemId.identifyDrivetrainSystem(Constants.DriveTrain.DriveCharacteristics.VOLTS,
				...
				DCMotor.getNEO(3), 6.7368, Constants.DriveTrain.DriveCharacteristics.TRACK_WIDTH,
				Units.inchesToMeters(5.75), null);
